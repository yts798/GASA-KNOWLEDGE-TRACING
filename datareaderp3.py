...
class readerp3(Dataset):
    ...
    def __getitem__(self, index):
        # print("start")
        # print(index)
        # print(len(self.q_seqs))
        # print(len(self.r_seqs))
        # print(len(self.a_seqs))
        # print(len(self.b_seqs))
        # print(len(self.c_seqs))
        # print("end")
    ...
    def preprocess(self):
        df = pd.read_csv(self.dataset_path, low_memory=False, nrows = 100000) \
